...
static ssize_t diag_dbgfs_read_status(struct file *file, char __user * ubuf, size_t count, loff_t * ppos)
{
	...
	ret = scnprintf(buf, DEBUG_BUF_SIZE,
			...
			"logging_mode: %d\n"
			"real_time_mode: %d\n",
			(unsigned int)(uintptr_t)driver->smd_data[MODEM_DATA].ch,
			(unsigned int)(uintptr_t)driver->smd_data[LPASS_DATA].ch,
			(unsigned int)(uintptr_t)driver->smd_data[WCNSS_DATA].ch,
			(unsigned int)(uintptr_t)driver->smd_dci[MODEM_DATA].ch,
			(unsigned int)(uintptr_t)driver->smd_cntl[MODEM_DATA].ch,
			(unsigned int)(uintptr_t)driver->smd_cntl[LPASS_DATA].ch,
			(unsigned int)(uintptr_t)driver->smd_cntl[WCNSS_DATA].ch,
			(unsigned int)(uintptr_t)driver->smd_cmd[MODEM_DATA].ch,
			(unsigned int)(uintptr_t)driver->smd_dci_cmd[MODEM_DATA].ch,
			chk_config_get_id(),
			chk_apps_only(),
			chk_apps_master(),
			...
			(unsigned int)(uintptr_t)driver->smd_data[MODEM_DATA].buf_in_1_size,
			(unsigned int)(uintptr_t)driver->smd_data[MODEM_DATA].buf_in_2_size,
			(unsigned int)(uintptr_t)driver->smd_data[LPASS_DATA].buf_in_1_size,
			(unsigned int)(uintptr_t)driver->smd_data[LPASS_DATA].buf_in_2_size,
			(unsigned int)(uintptr_t)driver->smd_data[WCNSS_DATA].buf_in_1_size,
			(unsigned int)(uintptr_t)driver->smd_data[WCNSS_DATA].buf_in_2_size,
			(unsigned int)(uintptr_t)driver->smd_data[MODEM_DATA].buf_in_1_raw_size,
			(unsigned int)(uintptr_t)driver->smd_data[MODEM_DATA].buf_in_2_raw_size,
			(unsigned int)(uintptr_t)driver->smd_data[LPASS_DATA].buf_in_1_raw_size,
			(unsigned int)(uintptr_t)driver->smd_data[LPASS_DATA].buf_in_2_raw_size,
			(unsigned int)(uintptr_t)driver->smd_data[WCNSS_DATA].buf_in_1_raw_size,
			(unsigned int)(uintptr_t)driver->smd_data[WCNSS_DATA].buf_in_2_raw_size,
			(unsigned int)(uintptr_t)driver->smd_cmd[MODEM_DATA].buf_in_1_size,
			(unsigned int)(uintptr_t)driver->smd_cmd[MODEM_DATA].buf_in_1_raw_size,
			(unsigned int)(uintptr_t)driver->smd_cntl[MODEM_DATA].buf_in_1_size,
			(unsigned int)(uintptr_t)driver->smd_cntl[LPASS_DATA].buf_in_1_size,
			(unsigned int)(uintptr_t)driver->smd_cntl[WCNSS_DATA].buf_in_1_size,
			(unsigned int)(uintptr_t)driver->smd_dci[MODEM_DATA].buf_in_1_size,
			(unsigned int)(uintptr_t)driver->smd_dci_cmd[MODEM_DATA].buf_in_1_size,
	...
	for (i = 0; i < MAX_HSIC_CH; i++) {
		if (diag_hsic[i].hsic_inited) {
			...
			bytes_written = scnprintf(buf + bytes_in_buffer,
						  ...
						  (unsigned int)(uintptr_t)diag_hsic[i].diag_hsic_pool,
						  (unsigned int)(uintptr_t)diag_hsic[i].diag_hsic_write_pool,
